...
# This is a dirt hack to override the variable that drone 1.0 sets in order to get the container started
# For more see also https://github.com/owncloud/core/issues/36002
export CI=drone
